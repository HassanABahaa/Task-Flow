...
const UserController = (() => {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      Utils.toast('Account created! Please check your email to activate.', 'success');
  ...
  const handleUpdateProfile = async (e) => {
    ...
    try {
      ...
      if (u) {
        ...
        document.getElementById('profile-avatar-text').textContent = Utils.initials(u.userName);
      }
  ...
  const bindEvents = () => {
    ...
    document.getElementById('forget-form')?.addEventListener('submit', handleSendCode);
